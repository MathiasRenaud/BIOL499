...
#------------------------------------------------------------------------------
# GO Biological Process (files[1]) - binary, only significant rows
#------------------------------------------------------------------------------
...
## In Progress: Remove terms with no significant assocaitions.
# mat2 <- matrix(nrow=length(IDs),ncol=length(miRs))
# n=0
# r=0
